...
## Host Reset Hard Fix
This build removes volatile `serverTime` from host render comparisons so polling does not re-render/reset the host dashboard every few seconds. Countdown text still updates live client-side.
